...
def imgslice(img, cpoint, angle=0, width=None):
    ...
    **Optional inputs**
    ...
    #xslice = np.linspace(startpt[0], stoppt[0], xmax*npts) # full img length
    #yslice = np.linspace(startpt[1], stoppt[1], xmax*npts)
...
def smooth(x, window_len=10, window='hanning'):
    ...
    **Outputs**
      ...
      * x_smooth: 1Darray, the smoothed signal
