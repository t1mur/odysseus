...
from imageprocess import trans2od, od2trans
from polylog import fermi_poly3


pixcal = 1e-5 # 10 um per pixel
h = 6.62606896e-34
hbar = h/(2*np.pi)
...
def idealfermi_fitparams(ToverTF, N, tof=0, wr=2e3, wz=100):
