...
def do_fit(rcoord, od_prof, od_cutoff, guess, fitfunc='idealfermi', T=None):
...
def fit_img(transimg, odmax=1., showfig=True, elliptic=None, \
    ...
    **Optional inputs**
    ...
    # do the fit
    guess = (n0, a, bprime)
    ToverTF, N, ans = do_fit(rcoord, od_prof, od_cutoff, guess, \
                             fitfunc=fitfunc, T=T)
