...
class MaxsizeMessagebox(QMessageBox):
    """Enforce a maximum size on the message box

    DOES NOT WORK. USE DIALOG!

    """

    def __init__(self, windowname, bodytext):
        super(MaxsizeMessagebox, self).__init__(parent, windowname, bodytext)
        print 'init!!'
